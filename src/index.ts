...
btnEnviar.addEventListener("click", () => {
  ...
  let sumaArreglo1: number[] = new Array(3);
  let sumaArreglo2: number[] = new Array(3);
  ...
  multiplicarArreglo(arreglo1, arreglo2, sumaArreglo1,3);
  multiplicarArreglo(arreglo3, arreglo4, sumaArreglo2,3);
  multiplicarArreglo(sumaArreglo1, sumaArreglo2, arregloFinal,3);
